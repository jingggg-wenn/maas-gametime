...
From the file explorer, navigate to the `coding-exercises/fun-and-games/game_starters` directory:

image::game-starters.png[width="50%"]

Open the game file, in the language of your choice.
...
[source,console]
----
cd /projects/coding-exercises/fun-and-games/game_starters/rock_paper_scissors/
----
...
[source,console]
----
/projects/coding-exercises/fun-and-games/game_solutions/
----
